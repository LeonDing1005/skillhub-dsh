...
| [`skill-installation/`](skill-installation/README.md) | Admits, manages, and provides immutable managed Community Skill packages | `ctx.skills` provider (Host-composed) |
