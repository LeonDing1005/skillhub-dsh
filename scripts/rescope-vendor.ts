...
const GENERIC_SKIPS: readonly GenericSkip[] = [
  ...
  // `cordis` is also the namespace for extension events, locale copy, and tool
  // presentation ids. These are product protocol values rather than package names.
  ...[
  ...
  // Dynamic Cordis uses `cordis` as its event prefix, UI locale namespace,
  // input-source name, and documentation catalog scope. These are runtime
  // identifiers, not references to the vendored framework package.
...
/** Generated descriptor/codec contribution with no shared runtime identity. */`,
  ...
  {
    id: 'cordis-client-runner-context-module',
    file: 'packages/extensions/cordis-client-runner/src/client/index.ts',
  ...
  {
    id: 'cordis-client-runner-spec-context-import',
  ...
  {
    id: 'cordis-host-runner-context-module',
    file: 'packages/extensions/cordis-host-runner/src/index.ts',
    find: "declare module 'cordis'",
    replace: "declare module '@deepseek-ai/cordis'",
    expect: 1,
  ...
  {
    id: 'cordis-inspect-registry-service-import',
  ...
  {
    id: 'cordis-inspect-registry-context-import',
    file: 'packages/extensions/cordis-host-runner/src/inspect-registry.ts',
    find: "import type { Context } from 'cordis'",
    replace: "import type { Context } from '@deepseek-ai/cordis'",
    expect: 1,
  ...
  {
    id: 'cordis-inspect-registry-context-module',
    file: 'packages/extensions/cordis-host-runner/src/inspect-registry.ts',
    find: "declare module 'cordis'",
    replace: "declare module '@deepseek-ai/cordis'",
    expect: 1,
  ...
  {
    id: 'cordis-host-runner-types-context-module',
  ...
  {
    id: 'cordis-host-runner-helpers-context-import',
  ...
  {
    id: 'tool-cordis-provider-context-import',
  ...
  {
    id: 'cordis-catalog-context-module-docs',
